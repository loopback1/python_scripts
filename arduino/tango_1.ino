/*
arduino motion sensor pet alarm with buzzer..
this came from some where on the web and was modified to fit my needs
*/
...
Serial.println(start_time);
 ...
 {
  //alarm goes off once plugged in due to sensor adjustment, dont go off until intruder count is at least 1
   if(start_count == 0){
    start_count++;
    return;
   }
